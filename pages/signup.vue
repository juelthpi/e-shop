<template>
  <div class="signup-page bg-light min-h-100vh d-flex flex-column">
          ...
          <div class="row g-0">
            ...
            <div class="col-lg-6 d-none d-lg-block">
              <div class="auth-img-wrapper h-100 position-relative">
                <img src="/assets/images/thumbanils/auth.jpg" alt="Sign Up" class="auth-image">
              ...
              <div class="auth-form-wrapper p-4 p-md-5 h-100 d-flex flex-column justify-content-center">
                ...
                <form @submit.prevent="handleSignup" class="signup-form">
                  ...
                  <div class="form-group mb-4">
                    <label class="form-label fw-bold mb-2">Name <span class="text-danger">*</span></label>
                    <input 
                      type="text" 
                      v-model="form.name" 
                  ...
                  <!-- Submit Button -->
                  <button type="submit" class="primary-btn sign-up-btn py-3 justify-content-center fw-bold w-100" :disabled="isSubmitting">
                  ...
                  <div class="text-center mt-5">
                    <p class="text-muted">Already have an account? <nuxt-link to="/login" class="text-brand fw-bold">Sign In</nuxt-link></p>
                  </div>
                </form>
              </div>
            </div>
...
const fetchCountries = async () => {
    try {
        ...
        const formatted = data
            .filter(c => c.idd?.root) // Only countries with calling codes
            .map(c => ({
                name: c.name.common,
